...
$product_rs = Database::search("SELECT * FROM `product` WHERE `bookname` LIKE '%".$in."%' OR `writter` LIKE '%".$in."%' ");
...
$selected_rs = Database::search("SELECT * FROM `product` WHERE `bookname` LIKE '%".$in."%' OR `writter` LIKE '%".$in."%' 
